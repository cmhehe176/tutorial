...
export class Init1715935240423 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`admins\` CHANGE \`role\` \`role_id\` varchar(255) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`admins\` DROP COLUMN \`role_id\``);
        await queryRunner.query(`ALTER TABLE \`admins\` ADD \`role_id\` varchar(255) NOT NULL`);
        await queryRunner.query(`DROP INDEX \`IDX_fe3119b8577cd8704656ee51d0\` ON \`role\``);
        await queryRunner.query(`DROP TABLE \`role\``);
        await queryRunner.query(`ALTER TABLE \`admins\` CHANGE \`role_id\` \`role\` varchar(255) NOT NULL`);
    }
